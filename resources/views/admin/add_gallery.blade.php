				  ...
				  <div class="card-body p-4">		
					  ...
					  <hr/>
                       <div class="form-body mt-4">
                        <form action="{{ url('insert-gallery') }}" method="post" enctype="multipart/form-data">
                            @csrf
                               <div class="border border-3 p-4 rounded borderRmv">
                              
                               	<div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">Image</label>
                                    <input type="file" name="image" required class="form-control" id="image" placeholder="Enter  image">
                                  </div>
                                 
                               
                                  <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">Links</label>
                                    <input type="text" name="links" required class="form-control" id="links" placeholder="Enter links">
                                  </div>
