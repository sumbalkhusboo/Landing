				  ...
				  <div class="card-body p-4">
					  ...
					  <hr/>
                       <div class="form-body mt-4">
                        <form action="{{ url('insert-project') }}" method="post" enctype="multipart/form-data">
                            @csrf
                               <div class="border border-3 p-4 rounded borderRmv">

                               	<div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">Project name</label>
                                    <input type="text" name="project_name" required class="form-control" id="name" placeholder="Enter project name">
                                  </div>
                                  ...
                                  <div class="mb-3">
                                   ...
                                   <div class="mb-3">
                                    ...
                                    <input type="text" name="link" required class="form-control" id="link" placeholder="Enter link">
                                  </div>
