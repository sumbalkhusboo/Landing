			...
			<div class="page-content">
				...
				<div class="card">
				  <div class="card-body p-4">		
					  <h5 class="card-title">Edit New Faqs</h5>
					  <hr/>
                            ...
                            @csrf
                               <div class="border border-3 p-4 rounded borderRmv">
                               	...
                               	<div class="mb-3">
                                    ...
                                    <input type="text" name="heading" value="{{$faq->heading}}" required class="form-control"
                                     id="heading" placeholder="Enter headings">
                                  </div>

                                  <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">detail</label>
                                    <input type="text" name="detail"value="{{$faq->detail}}"  required class="form-control" 
                                    id="detail" placeholder="Enter details">
                                  </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="links" value="{{$faq->links}}"
                                   id="link" placeholder="Enter links">
                                  </div>
