                            ...
                            @csrf
                               <div class="border border-3 p-4 rounded borderRmv">
                               	...
                               	<div class="mb-3">
                                    ...
                                    <input type="text" name="project_name" value="{{$project->project_name}}" required class="form-control" id="name" placeholder="Enter project name">
                                  </div>

                                  <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">description</label>
                                    <input type="text" name="description" value="{{$project->description}}" required class="form-control" id="description" placeholder="Enter description">
                                  </div>


                                   <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">Link</label>
                                    <input type="text" name="link" value="{{$project->link}}" required class="form-control" id="link" placeholder="Enter link">
                                  </div>
