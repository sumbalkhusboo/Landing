				  ...
				  <div class="card-body p-4">		
					  ...
					  <hr/>
                       <div class="form-body mt-4">
                        <form action="{{ url('insert_folder') }}" method="post" enctype="multipart/form-data">
                            ...
                            @csrf
                               <div class="border border-3 p-4 rounded borderRmv">
                                <div class="mb-3">
                               	...
                               	<div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">Folder Image</label>
                                    <input type="file" name="folder_img" required class="form-control" id="folder_img" placeholder="Enter  folder image">
                                  </div>
